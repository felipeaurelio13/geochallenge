...
export function Header({
  ...
  return (
    <header className={`sticky top-0 z-20 border-b border-gray-800/80 bg-gray-950/95 backdrop-blur supports-[padding:max(0px)]:pt-[env(safe-area-inset-top)] ${className}`.trim()}>
