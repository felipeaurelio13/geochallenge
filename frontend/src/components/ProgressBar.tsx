...
export function ProgressBar({ current, total, results }: ProgressBarProps) {
  ...
  return (
    <div className="w-full">
      <div className="h-3 rounded-full bg-gray-700/80 p-0.5">
        <div
      ...
      <div className="scrollbar-none mt-3.5 -mx-1 flex items-center gap-2 overflow-x-auto px-1 pb-1 sm:mx-0 sm:justify-between sm:overflow-visible sm:px-0 sm:pb-0">
