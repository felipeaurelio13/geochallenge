...
export const featureFlags = {
  uxV2: {
    ...
    duel: parseBoolFlag(import.meta.env.VITE_UX_V2_DUEL, true),
    challenge: parseBoolFlag(import.meta.env.VITE_UX_V2_CHALLENGE, true),
    practice: true,
  ...
  mechanicsV2: {
    ...
    duel: parseBoolFlag(import.meta.env.VITE_MECHANICS_V2_DUEL, true),
    challenge: parseBoolFlag(import.meta.env.VITE_MECHANICS_V2_CHALLENGE, true),
    practice: false,
  } satisfies ModeFlagSet,
  telemetry: {
