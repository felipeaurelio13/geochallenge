...
- Fix: Rankings muestra estadísticas globales desde backend (`totalPlayers`, `topScore` y `avgScore` opcional) y separa claramente estado Global vs Filtrado por búsqueda.
